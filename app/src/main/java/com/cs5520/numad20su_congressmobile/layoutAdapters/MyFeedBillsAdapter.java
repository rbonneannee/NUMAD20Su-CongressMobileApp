 ...
 */
public class MyFeedBillsAdapter extends RecyclerView.Adapter<MyFeedBillsAdapter.ViewHolder> {

  private final List<DummyItem> mValues;
  private int lastPosition = -1;
  private Context context;

  public MyFeedBillsAdapter(List<DummyItem> items) {
    mValues = items;
  }
  ...
  @Override
  public void onViewDetachedFromWindow(@NonNull MyFeedBillsAdapter.ViewHolder holder) {
