...
public class BillsViewContent extends AbstractViewContent<Bill> {
   ...
   * all bills, and its endpoints to the server endpoints supported by the application.
   *
   ...
   * bills. Results are from the current meeting of Congress and are organized in descending order
